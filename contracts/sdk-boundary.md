...
## Version
- **Current:** 1.14 (SDK v1.0.7 — ToolForwarding hardened: `SDKToolWrapper.metadata` added to mirror the SDK's new `copilot.tools.Tool.metadata` field, read during tool-definition serialization on both the create and resume paths)
